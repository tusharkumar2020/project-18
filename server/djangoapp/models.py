...
class CarMake(models.Model):
    ...
    country_of_origin = models.CharField(max_length=100, blank=True, help_text="The country where the car make originates.")
    established_year = models.PositiveIntegerField(null=True, blank=True, help_text="The year the car make was established.")
