            ...
            fields=[
                ('id',
                 models.BigAutoField(auto_created=True,
                                     ...
                                     verbose_name='ID')),
                ('dealer_id',
                 models.IntegerField(help_text='The dealer ID associated with this car model.')),
                ('name',
                 models.CharField(help_text='The name of the car model.',
                                  max_length=100)),
                ('type',
                 models.CharField(choices=[('Sedan', 'Sedan'),
                                           ('SUV', 'SUV'),
                                           ('Wagon', 'Wagon')],
                                  help_text='The type of car model.', max_length=10)),
                ('year',
                 models.DateField(help_text='The year this car model was manufactured.')),
                ('color',
                 models.CharField(blank=True,
                                  help_text='The color of the car model.',
                                  max_length=50)),
                ('car_make',
                 models.ForeignKey(help_text='The car make this model belongs to.',
